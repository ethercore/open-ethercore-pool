## Open Source EtherCore Mining Pool

![Miner's stats page](https://user-images.githubusercontent.com/7374093/31591180-43c72364-b236-11e7-8d47-726cd66b876a.png)

[![Build Status](https://travis-ci.org/ethercoreorg/open-ethercore-pool.svg?branch=develop)](https://travis-ci.org/ethercoreorg/open-ethercore-pool) [![Go Report Card](https://goreportcard.com/badge/github.com/ethercoreorg/open-ethercore-pool)](https://goreportcard.com/report/github.com/ethercoreorg/open-ethercore-pool)

### Features

* Exclusive support for [EtherCore](https://ethercore.org) mining (Supports ECIP-1017 for block reward calculation).
* Support for ProgPoW, a Programmatic Proof-of-Work GPU friendly mining algorithm.
...
First install [go-ethercore](https://github.com/ethercoreorg/go-ethercore/releases/latest).

Clone & compile:

    git clone https://github.com/ethercoreorg/open-ethercore-pool.git
...
```javascript
{
  ...
  /* List of go-ethercore nodes to poll for new jobs. Pool will try to get work from
  ...
  */
  ...
  "unlocker": {
    ...
    "interval": "10m",
    // go-ethercore node rpc endpoint for unlocking blocks
    "daemon": "http://127.0.0.1:8545",
    // Rise error if can't reach go-ethercore
    "timeout": "10s"
  },
  ...
  "payouts": {
    ...
    "interval": "24h",
    // go-ethercore node rpc endpoint for payouts processing
    "daemon": "http://127.0.0.1:8545",
    // Rise error if can't reach go-ethercore
    "timeout": "10s",
    // Address with pool balance
    "address": "0x0",
    // Let go-ethercore to determine gas and gasPrice
    "autoGas": true,
...
Made by sammy007. Modified for EtherCore. Licensed under GPLv3.
